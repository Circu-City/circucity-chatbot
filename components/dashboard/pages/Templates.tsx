    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-bold text-dark-navy">Response Templates</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        {filtered.length === 0 && (
          <div className="col-span-full text-center py-12 text-gray-400 text-sm">
            ...
            <p>No templates yet. Create your first response template.</p>
          </div>
        )}
      </div>
        ...
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4" onClick={() => setShowEditor(false)}>
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg p-6" onClick={e => e.stopPropagation()}>
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="text-xs font-semibold text-muted-foreground block mb-1">Response Content</label>
              ...
              <div>
                <label className="text-xs font-semibold text-muted-foreground block mb-1">Variables (comma separated)</label>
