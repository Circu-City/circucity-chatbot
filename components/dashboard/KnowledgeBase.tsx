...
export default function KnowledgeBase() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div>
        <h2 className="text-2xl font-bold text-dark-navy">Knowledge Base</h2>
      ...
      <Card className="p-6 border-border shadow-sm">
        <div className="flex items-center gap-3 mb-3">
          ...
          <h3 className="font-bold text-dark-navy">Website Data (Auto-Crawled)</h3>
        </div>
      ...
      {activeTab === "faqs" && (
        <div className="space-y-6">
          <Card className="p-6 border-border shadow-sm">
            <h3 className="font-bold text-dark-navy mb-4">Add FAQ</h3>
          ...
          {faqs.length > 0 ? (
            ...
            <Card className="p-12 border-border shadow-sm text-center">
              ...
              <p className="text-muted-foreground">No FAQs yet. Add one above to get started.</p>
            </Card>
          )}
        </div>
      )}
      ...
      {activeTab === "documents" && (
        <div className="space-y-6">
          <Card className="p-6 border-border shadow-sm">
            <h3 className="font-bold text-dark-navy mb-4">Add Document</h3>
            <div className="space-y-3">
              <input
                type="text"
                value={newDocName}
          ...
          {documents.length > 0 ? (
            ...
            <Card className="p-12 border-border shadow-sm text-center">
              ...
              <p className="text-muted-foreground">No documents yet. Add one above to get started.</p>
            </Card>
          )}
        </div>
      )}
