...
{message && (
      ...
      {activeTab === "profile" && (
        <Card className="border-border shadow-sm">
          <CardContent className="p-6 space-y-6">
            <h3 className="font-bold text-dark-navy flex items-center gap-2"><User className="w-5 h-5 text-primary" /> Profile Information</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2"><label className="text-sm font-medium text-dark-navy">Store Name</label>
                <Input value={profileForm.name} onChange={(e) => setProfileForm({ ...profileForm, name: e.target.value })} /></div>
              <div className="space-y-2"><label className="text-sm font-medium text-dark-navy">Email</label>
                <Input value={profileForm.email} disabled className="bg-slate-50" /></div>
              <div className="space-y-2"><label className="text-sm font-medium text-dark-navy">Website URL</label>
                <Input value={profileForm.url} onChange={(e) => setProfileForm({ ...profileForm, url: e.target.value })} placeholder="https://example.com" /></div>
              <div className="space-y-2"><label className="text-sm font-medium text-dark-navy">Industry</label>
      ...
      {activeTab === "business" && (
        <Card className="border-border shadow-sm">
          <CardContent className="p-6 space-y-6">
            <h3 className="font-bold text-dark-navy flex items-center gap-2"><Globe className="w-5 h-5 text-primary" /> Business Profile</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2"><label className="text-sm font-medium text-dark-navy">Workspace Name</label>
                <Input value={wsForm.name} onChange={(e) => setWsForm({ ...wsForm, name: e.target.value })} /></div>
              <div className="space-y-2"><label className="text-sm font-medium text-dark-navy">Business Name</label>
                <Input value={wsForm.businessName} onChange={(e) => setWsForm({ ...wsForm, businessName: e.target.value })} /></div>
              <div className="md:col-span-2 space-y-2"><label className="text-sm font-medium text-dark-navy">About Business</label>
              ...
              <div className="space-y-2"><label className="text-sm font-medium text-dark-navy">Contact Info</label>
              ...
              <div className="space-y-2"><label className="text-sm font-medium text-dark-navy">Operating Hours</label>
      ...
      {activeTab === "website" && (
        <Card className="border-border shadow-sm">
          <CardContent className="p-6 space-y-6">
            <h3 className="font-bold text-dark-navy flex items-center gap-2"><Search className="w-5 h-5 text-primary" /> Website Source</h3>
            <div className="space-y-2"><label className="text-sm font-medium text-dark-navy">Primary Website URL</label>
              <div className="flex gap-2">
                ...
                <Button variant="outline" onClick={handleCrawl}><RefreshCw className="w-4 h-4 mr-2" /> Re-index</Button>
              </div>
            </div>
            <div className="flex items-center justify-between p-4 bg-slate-50 rounded-lg border">
              <div><p className="text-sm font-medium text-dark-navy">Crawl Status</p><p className="text-xs text-muted-foreground">{workspace?.crawlStatus === "crawling" ? "Crawling..." : workspace?.crawlStatus || "Not yet crawled"}</p></div>
      ...
      {activeTab === "ai" && (
        <Card className="border-border shadow-sm">
          <CardContent className="p-6 space-y-6">
            <h3 className="font-bold text-dark-navy flex items-center gap-2"><Bot className="w-5 h-5 text-primary" /> AI Configuration</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2"><label className="text-sm font-medium text-dark-navy">Personality</label>
                <select className="w-full px-3 py-2 bg-white border border-border rounded-md text-sm outline-none" value={wsForm.personality} onChange={(e) => setWsForm({ ...wsForm, personality: e.target.value })}>
                  <option value="professional">Professional</option><option value="friendly">Friendly</option><option value="sales">Sales Focused</option><option value="custom">Custom</option>
                </select></div>
              <div className="space-y-2"><label className="text-sm font-medium text-dark-navy">Tone</label>
                <select className="w-full px-3 py-2 bg-white border border-border rounded-md text-sm outline-none" value={wsForm.tone} onChange={(e) => setWsForm({ ...wsForm, tone: e.target.value })}>
                  <option value="professional">Professional</option><option value="friendly">Friendly</option><option value="casual">Casual</option><option value="formal">Formal</option>
                </select></div>
      ...
      {activeTab === "api" && (
        <div className="space-y-6">
          ...
          <Card className="border-border shadow-sm">
            <CardContent className="p-6 space-y-4">
              <h3 className="font-bold text-dark-navy">Workspace ID</h3>
          ...
          <Card className="border-border shadow-sm">
            <CardContent className="p-6 space-y-4">
              <h3 className="font-bold text-dark-navy">Embed Code</h3>
